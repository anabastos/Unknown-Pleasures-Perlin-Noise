...
let run = exports.run = (() => {
  var _ref6 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (config, reporter, flags, args) {
    ...
    const depRequests = _ref8[0];
    const patterns = _ref8[1];
    ...
    const transitiveKeys = new (_set || _load_set()).default(transitiveDependencies.map(function (_ref11) {
